                ...
                <div class="app-modal-form">
                    <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="app-modal-body">
                            ...
                            <div class="avatar av-l upload-avatar-preview FarmCHAT-d-flex"
                            style="background-image: url('{{ FarmCHAT::getUserWithAvatar(Auth::user())->avatar }}');"
                            ></div>
                            <p class="upload-avatar-details"></p>
                            <label class="app-btn a-btn-primary update" style="background-color:{{$messengerColor}}">
                                Upload New
                                <input class="upload-avatar FarmCHAT-d-none" accept="image/*" name="avatar" type="file" />
                            </label>
                            {{-- Dark/Light Mode  --}}
                            <p class="divider"></p>
                            ...
                            <p class="divider"></p>
                            {{-- <p class="app-modal-header">Change {{ config('FarmCHAT.name') }} Color</p> --}}
                            <div class="update-messengerColor">
                            @foreach (config('FarmCHAT.colors') as $color)
