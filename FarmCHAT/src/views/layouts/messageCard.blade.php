    ...
    <div class="message-card-content">
        @if (@$attachment->type != 'image' || $message)
            <div class="message">
                ...
                <a href="{{ route(config('FarmCHAT.attachments.download_route_name'), ['fileName'=>$attachment->file]) }}" class="file-download">
        ...
        <div class="image-wrapper" style="text-align: {{$isSender ? 'end' : 'start'}}">
            <div class="image-file chat-image" style="background-image: url('{{ FarmCHAT::getAttachmentUrl($attachment->file) }}')">
