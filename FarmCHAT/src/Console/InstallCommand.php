...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'FarmCHAT:install';
     ...
     * @var string
     */
    protected $description = 'Install FarmCHAT package';
    ...
    public function handle()
    {
        ...
        $this->modifyModelsPath('/../FarmCHATMessenger.php','ChFavorite');
        $this->modifyModelsPath('/../FarmCHATMessenger.php','ChMessage');
        $this->modifyModelsPath('/../Models/ChFavorite.php');
        $this->modifyModelsPath('/../Models/ChMessage.php');
        $this->info('[✓] done');

        $assetsToBePublished = [
            'config' => config_path('FarmCHAT.php'),
            'views' => resource_path('views/vendor/FarmCHAT'),
            'assets' => public_path('css/FarmCHAT'),
            ...
            'routes' => base_path('routes/FarmCHAT'),
        ];
        ...
        $this->line('----------');
        $this->info('[✓] FarmCHAT installed successfully');
    }
